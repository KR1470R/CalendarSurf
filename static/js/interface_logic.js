                                ...
                                //}catch(e){return}
												        ...
												        table_event_container.animate([{opacity:1},{opacity:0}],{duration:100, fill:"both"});setTimeout(()=>{
												        	table_event_container.style.display = 'none';table_event_container.outerHTML = ''
													       	let add_loading_container = document.createElement("div")
													       	add_loading_container.setAttribute("id","loading")
													       	let add_loading = document.createElement('img')
	          											add_loading.setAttribute("id", "loading_container");add_loading.setAttribute("src", "static/img/loading.gif")
	          											get_event_list.appendChild(add_loading_container)
	          											add_loading_container.appendChild(add_loading)
		          										$.ajax({
													            type: "POST",
													            url: '/countries/',
